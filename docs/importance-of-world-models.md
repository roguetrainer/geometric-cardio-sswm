...
## 📢 Why SSWMs Are in the News (2025)
...
2.  **The Robotics and Embodied AI Boom:** Companies are investing heavily in humanoid and domestic robots, but these machines struggle with basic real-world tasks. LeCun and others argue that SSWMs—which can predict how the world changes based on an action—are the fundamental AI breakthrough needed to give robots the ability to **plan complex, zero-shot action sequences** (i.e., figure out how to do a new task without specific training).
...
## 🙋 The Yann LeCun Factor: A Major Advocate
